...
from nets.attention import CBAM
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, pretrained=False):
        ...
        # ----------------------------------#
        # self.feat1_attention = CBAM(512)
        # self.feat2_attention = CBAM(1024)
        # self.feat3_attention = CBAM(1024)
        # self.upsample_attention = CBAM(256)
        # ----------------------------------#
